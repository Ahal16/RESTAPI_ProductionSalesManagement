...
using ProductSalesManagement.Models;
using ProductSalesManagement.Repository;
using ProductSalesManagement.ViewModel;
...
namespace ProductSalesManagement.Controllers
{
    ...
    public class ProductSalesController : ControllerBase
    {
        ...
        //// GET: api/<ProductSalesController>
        //[HttpGet]
        ...
        //// GET api/<ProductSalesController>/5
        //[HttpGet("{id}")]
        ...
        //// POST api/<ProductSalesController>
        //[HttpPost]
        //public void Post([FromBody] string value)
        //{
        //}

        //// PUT api/<ProductSalesController>/5
        //[HttpPut("{id}")]
        //public void Put(int id, [FromBody] string value)
        //{
        //}

        //// DELETE api/<ProductSalesController>/5
        //[HttpDelete("{id}")]
